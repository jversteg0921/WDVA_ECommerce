...
namespace WDVA_ECommerce.Server.Migrations
{
    ...
    [Migration("20230906040423_AdditionalPersonalProperties")]
    partial class AdditionalPersonalProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WDVA_ECommerce.Shared.CartItem", b =>
                {
            ...
            modelBuilder.Entity("WDVA_ECommerce.Shared.OrderItem", b =>
                {
                    b.HasOne("WDVA_ECommerce.Shared.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WDVA_ECommerce.Shared.Product", "Product")
                        .WithMany()
